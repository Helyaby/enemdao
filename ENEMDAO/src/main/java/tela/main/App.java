...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Esse FXML contém a estrutura base da interface (menu lateral + painel de
        // conteúdo)
        Parent root = FXMLLoader.load(getClass().getResource("/telas/view/MainLayout.fxml"));

        // Cria uma cena (área visível) com o layout carregado e define o tamanho da
        // janela
        ...
        // No método start, altere o título:
        primaryStage.setTitle("📚 Sistema de Questões ENEM");
